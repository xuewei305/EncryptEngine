	  ...
	  )
{
	...
	case IOCTL_ADD_PROCESS_INFO://
		{
			...
			KdPrint(("======================== IN IOCTL_ADD_PROCESS_INFO ====================================="));
	...
	case IOCTL_SET_MONITOR:
		{			
			...
			//Set All Process's State by InputBuffer's State PMSG_SEND_SET_PROCESS_INFO psSendSetProcInfo = (PMSG_SEND_SET_PROCESS_INFO)InputBuffer ;
