...
#define IOCTL_SET_MONITOR          0x00000007			//For Start Process Monitor
#define IOCTL_SET_KEYLIST          0x00000008
#define IOCTL_GET_MONITOR          0x00000009
  
/*FilterSupport API return values*/
#define FILTER_SUPPORT_API_RETURN_SUCCESS   				 									0x00000001//Successfual calling
#define FILTER_SUPPORT_API_RETURN_ERROR_INVALID_PARAMETER										0x00000002
#define FILTER_SUPPORT_API_RETURN_ERROR_INSUFFICIENT_MEMORY										0X00000003//error to malloc enough memory
#define FILTER_SUPPORT_API_RETURN_ERROR_OPEN_PORT												0X00000004//failed to open communication port
#define FILTER_SUPPORT_API_RETURN_ERROR_SEND_MESSAGE											0X00000005//failed to call FilterSendMessage function.
#define FILTER_SUPPORT_API_RETURN_ERROR_HAVE_RUNNING											0x00000006//Driver has running
#define FILTER_SUPPORT_API_RETURN_ERROR_NOT_FIND_DRIVER											0X00000007//Deriver not found 
#define FILTER_SUPPORT_API_RETURN_ERROR															0x00000008//error ,call GetHresult to get more information .
